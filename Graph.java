...
g.addVertex("Sultan Bazaar~R");
g.addVertex("Parade Ground~R");
g.addVertex("Secunderabad East~R");
g.addVertex("Necklace Road~R");
g.addVertex("Khairatabad~R");
g.addVertex("Sriram Nagar~R");
g.addVertex("Sanjeeva Reddy Nagar~R");
g.addVertex("Ameerpet~R");
g.addVertex("Madhapur~R");
g.addVertex("Hitec City~R");
g.addVertex("Raidurg~R");
g.addVertex("Durgam Cheruvu~R");
g.addVertex("Shilparamam~R");

// Adding Blue Line stations
g.addVertex("MG Bus Station~B");
g.addVertex("Parade Ground~B");
g.addVertex("Ameerpet~B");
g.addVertex("SR Nagar~B");
g.addVertex("Erragadda~B");
g.addVertex("JNTU College~B");
g.addVertex("Miyapur~B");

// Adding Green Line stations (same as Blue Line)
g.addVertex("MG Bus Station~G");
g.addVertex("Parade Ground~G");
g.addVertex("Ameerpet~G");
g.addVertex("SR Nagar~G");
g.addVertex("Erragadda~G");
g.addVertex("JNTU College~G");
g.addVertex("Miyapur~G");

// Adding Red Line edges (distances)
g.addEdge("MG Bus Station~R", "Sultan Bazaar~R", 2);
g.addEdge("Sultan Bazaar~R", "Parade Ground~R", 1);
g.addEdge("Parade Ground~R", "Secunderabad East~R", 2);
g.addEdge("Secunderabad East~R", "Necklace Road~R", 2);
g.addEdge("Necklace Road~R", "Khairatabad~R", 2);
g.addEdge("Khairatabad~R", "Sriram Nagar~R", 3);
g.addEdge("Sriram Nagar~R", "Sanjeeva Reddy Nagar~R", 2);
g.addEdge("Sanjeeva Reddy Nagar~R", "Ameerpet~R", 3);
g.addEdge("Ameerpet~R", "Madhapur~R", 5);
g.addEdge("Madhapur~R", "Hitec City~R", 2);
g.addEdge("Hitec City~R", "Raidurg~R", 3);
g.addEdge("Raidurg~R", "Durgam Cheruvu~R", 1);
g.addEdge("Durgam Cheruvu~R", "Shilparamam~R", 1);

// Adding Blue Line edges (distances)
g.addEdge("MG Bus Station~B", "Parade Ground~B", 3);
g.addEdge("Parade Ground~B", "Ameerpet~B", 4);
g.addEdge("Ameerpet~B", "SR Nagar~B", 3);
g.addEdge("SR Nagar~B", "Erragadda~B", 2);
g.addEdge("Erragadda~B", "JNTU College~B", 3);
g.addEdge("JNTU College~B", "Miyapur~B", 5);

// Adding Green Line edges (same as Blue)
g.addEdge("MG Bus Station~G", "Parade Ground~G", 3);
g.addEdge("Parade Ground~G", "Ameerpet~G", 4);
g.addEdge("Ameerpet~G", "SR Nagar~G", 3);
g.addEdge("SR Nagar~G", "Erragadda~G", 2);
g.addEdge("Erragadda~G", "JNTU College~G", 3);
g.addEdge("JNTU College~G", "Miyapur~G", 5);
